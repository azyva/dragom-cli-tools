...
@echo off
set DRAGOM_HOME=%~dp0%..
%JAVA_HOME%\bin\java -classpath %DRAGOM_HOME%\lib\* -Djava.util.logging.config.file=%DRAGOM_HOME%/config/logging.properties -Dorg.azyva.dragom.UrlModel=file:///%DRAGOM_HOME%/config/model.xml org.azyva.dragom.tool.CheckoutTool %*
